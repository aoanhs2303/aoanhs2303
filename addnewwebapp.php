...
<?php 
    if(isset($_POST['Submit'])) {
        ...
        if (empty($Title)) {
            ...
            global $Connection;
            $Query = "INSERT INTO web_app(title, datetime, image, link) VALUES('$Title', '$DateTime', '$Image', '$Link')";
            $Execute = mysqli_query($Connection, $Query);
            move_uploaded_file($_FILES["Image"]["tmp_name"],$Target);
            if($Execute) {
                $_SESSION["SuccessMessage"] = "Ngon ! Thêm được rồi nhé";
                Redirect_to("addnewwebapp.php");
            } else {
        ...
        <div class="row">
            <div class="col-2">
                ...
                <ul class="dashboard nav flex-column nav-pills">
                    ...
                    <li class="nav-item"><a  class="nav-link active" href="addnewwebapp.php"><i class="fa fa-gamepad"></i>&nbsp;Add New Web App</a></li>
            ...
            <div class="col-10" style="background: #444">
                <nav class="navbar navbar-light bg-faded">
                    <h1 class="navbar-brand mb-0">Add new Web Application</h1>
                </nav>
                <?php 
                //Xuat thong bao
                echo Success();
                ...
                ?>
                <div class="content">
                    <form method="post" action="addnewwebapp.php" style="background-color: #FFF; padding: 40px" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="imageselect">Enter link</label>
                            <input type="text" name="link" class="form-control" id="link" placeholder="Enter your link">
                        </div>
                        <div class="form-group">
