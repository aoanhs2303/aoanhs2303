...
<?php 
    if(isset($_POST['Submit'])) {
        ...
        $Target="imageMansory/".basename($_FILES["Image"]["name"]);    
        date_default_timezone_set('Asia/Ho_Chi_Minh');
        $CurrentTime = time();
        $DateTime = strftime("%B-%m-%Y %H:%M:%S", $CurrentTime);
        
        if (empty($Image) || empty($Category)) {
            $_SESSION["ErrorMessage"] = "Sao mày đéo chọn gì hết vậy";
            Redirect_to("addnewpicture.php");
        } 
        else {
            global $Connection;
            $Query = "INSERT INTO picture(datetime, kind, image) VALUES('$DateTime', '$Category', '$Image')";
        ...
        <div class="row">
            <div class="col-2">
                ...
                <ul class="dashboard nav flex-column nav-pills">
                    ...
                    <li class="nav-item"><a  class="nav-link active" href="addnewpicture.php"><i class="fa fa-picture-o"></i>&nbsp;Picture</a></li>
            ...
            <div class="col-10" style="background: #444">
                <nav class="navbar navbar-light bg-faded">
                    <h1 class="navbar-brand mb-0">Add new Picture</h1>
                </nav>
                <?php 
                //Xuat thong bao
                echo Success();
                ...
                ?>
                <div class="content">
                    <form method="post" action="addnewpicture.php" style="background-color: #FFF; padding: 40px" enctype="multipart/form-data">
